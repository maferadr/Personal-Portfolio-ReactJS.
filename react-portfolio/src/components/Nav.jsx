            ...
            <div className="flex lg:flex-1">
                ...
                {/* Apply some conditionals => If our nav statement is true, display some html */}
                    {
                        nav ? (
                            <div className="fixed w-full h-screen bg-white/80 flex flex-col justify-center items-center z-20">
                                ...
                                <Link to='/resume' className="w-[75%] flex justify-center items-center rounded-full shadow-lg bg-brown-100 shadow-gray-400 m-2 p-4 hover:scale-110 ease-in duration-200">
                ...
                <div id="title-name" className="md:block hidden fixed top-[2%] z-10 right-4">
                    <div className="flex flex-row">
                            ...
                            <Link id="navbar" to='/resume' className="justify-between m-3 border-b-2">RESUME</Link>
                    </div>
                </div>  
            </div>
        </>
