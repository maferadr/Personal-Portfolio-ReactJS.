                ...
                {/* Apply some conditionals => If our nav statement is true, display some html */}
                    {
                        nav ? (
                            <>
                             <div className="fixed w-full h-screen bg-gradient-to-r from-orange-200/80 to-white/80 flex flex-col justify-center items-center z-20">
                                ...
                                <Link to='/about' className="w-[75%] flex justify-center items-center rounded-full shadow-lg bg-brown-100 shadow-stone-500 m-2 p-4 hover:scale-110 ease-in duration-200">
                                    <AiOutlineUser size={20}/>
                                    <span className="pl-4">ABOUT ME</span>
                                </Link>
                                <Link to='/portfolio' className="w-[75%] flex justify-center items-center rounded-full shadow-lg bg-brown-100 shadow-stone-500 m-2 p-4 hover:scale-110 ease-in duration-200">
                                    <AiOutlineFolderOpen size={20}/>
                                    <span className="pl-4">PORTFOLIO</span>
                                </Link>
                                <Link to='/education' className="w-[75%] flex justify-center items-center rounded-full shadow-lg bg-brown-100 shadow-stone-500 m-2 p-4 hover:scale-110 ease-in duration-200">
